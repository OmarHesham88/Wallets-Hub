...
public class WalletHeartbeatWorker extends Worker {
    ...
    @NonNull @Override public Result doWork() {
        ...
        try {
            ...
            body.put("notificationPermissionGranted", NotificationManagerCompat.getEnabledListenerPackages(context).contains(context.getPackageName()));
            ...
            putTime(body, "lastNotificationAtUtc", preferences.getLong(WalletCapturePlugin.LAST_NOTIFICATION_AT, 0));
