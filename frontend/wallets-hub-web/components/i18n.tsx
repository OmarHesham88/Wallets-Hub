...
const arabic: Record<string, string> = {
  ...
  "Capture Axis, Vodafone Cash, InstaPay, Orange Cash, and e& Cash payments and give every employee exactly the access they need.": "التقط مدفوعات Axis وVodafone Cash وInstaPay وOrange Cash وe& Cash وامنح كل موظف الصلاحيات التي يحتاجها فقط.",
  ...
  "Wallet payments captured from SMS, plus secure Axis notification capture.": "التقاط مدفوعات المحافظ من الرسائل النصية، مع التقاط آمن لإشعارات Axis.",
  ...
  "Axis notification access": "صلاحية إشعارات Axis",
  "Last Axis notification checked": "آخر إشعار Axis تم فحصه",
  "SMS access (Vodafone, InstaPay, Orange, e& Cash)": "صلاحية الرسائل (Vodafone وInstaPay وOrange وe& Cash)",
  "Enable Axis capture:": "تفعيل التقاط Axis:",
  "Open notification access": "فتح صلاحية الإشعارات",
  "Permission required": "الصلاحية مطلوبة",
  "Enabled · no Axis notification yet": "مفعّل · لا يوجد إشعار Axis بعد",
  ...
  "From": "من",
  "App payment alerts": "تنبيهات الدفعات في التطبيق",
  "Receive an Android notification only when Wallets Hub records incoming money for a wallet you can access.": "استلم إشعاراً على أندرويد فقط عند تسجيل أموال واردة لمحفظة يمكنك الوصول إليها.",
  "Enabled on this phone": "مفعّلة على هذا الهاتف",
  "Blocked in Android settings": "محظورة في إعدادات أندرويد",
  "Waiting for server activation": "بانتظار تفعيل الخادم",
  "Could not register this phone": "تعذر تسجيل هذا الهاتف",
  "Not enabled yet": "غير مفعّلة بعد",
  "Enable app notifications": "تفعيل إشعارات التطبيق",
  "Enabling…": "جارٍ التفعيل…",
  "Your existing receipt threshold and wallet permissions are respected.": "سيتم احترام الحد الأدنى الحالي للتنبيهات وصلاحيات المحافظ.",
  "To": "إلى",
  "Today": "اليوم",
  "7 days": "7 أيام",
  "30 days": "30 يوماً",
