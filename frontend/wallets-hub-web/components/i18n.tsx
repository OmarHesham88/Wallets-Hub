...
const arabic: Record<string, string> = {
  ...
  "See whether each wallet phone is connected and capturing payments.": "تحقق من اتصال كل هاتف محفظة واستمراره في التقاط المدفوعات.",
  ...
  "Wallet connections": "اتصالات المحافظ",
  "SMS wallets": "محافظ الرسائل النصية",
  "App-notification wallets": "محافظ إشعارات التطبيقات",
  "Connected": "متصل",
  "Setup needed": "الإعداد مطلوب",
  "Needs setup": "يحتاج إلى إعداد",
  "Connected and waiting for the first payment.": "متصل وفي انتظار أول دفعة.",
  "Technical details": "التفاصيل التقنية",
  "App notification capture": "التقاط إشعارات التطبيقات",
  "SMS capture permission": "صلاحية التقاط الرسائل",
  "Last notification checked": "آخر إشعار تم فحصه",
  "Last payment match": "آخر دفعة مطابقة",
  "Allow notification capture": "السماح بالتقاط الإشعارات",
