...
const arabic: Record<string, string> = {
  ...
  "Connect wallet phones, assign employee access, capture receipts, and understand every EGP, USD, or USDT movement from a clean operational dashboard.": "اربط هواتف المحافظ، وحدد صلاحيات الموظفين، والتقط عمليات الاستلام، وتابع كل حركة بالجنيه أو الدولار أو USDT من لوحة تشغيل واضحة.",
  ...
  "Capture Vodafone Cash and InstaPay SMS messages, monitor Binance notifications, and give every employee exactly the access they need.": "التقط رسائل Vodafone Cash وInstaPay، وراقب إشعارات Binance، وامنح كل موظف الصلاحيات التي يحتاجها فقط.",
  ...
  "Vodafone Cash and InstaPay from SMS, plus Binance payments from notifications.": "Vodafone Cash وInstaPay من الرسائل، ومدفوعات Binance من الإشعارات.",
  ...
  "Received today · USD": "المستلم اليوم · دولار",
  "Received today · USDT": "المستلم اليوم · USDT",
  ...
  "Last Binance notification": "آخر إشعار Binance",
