...
type Device = { id: string; name: string; platform: string; isActive: boolean; pairedAtUtc?: string; lastSeenAtUtc?: string; lastHeartbeatAtUtc?: string; lastSmsAtUtc?: string; lastCaptureAtUtc?: string; appVersion?: string; androidVersion?: string; pendingUploadCount: number; failedUploadCount: number; smsPermissionGranted: boolean; batteryOptimizationIgnored: boolean; walletCount: number };
